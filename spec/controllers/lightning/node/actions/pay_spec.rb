  ...
  describe 'send through keysend' do
    ...
    context 'gradual' do
      it 'flows' do
        ...
        Contract.expect(
          model.to_h, 'f3f98ff41f35d3047890a8bedcb3b6eb4e0621b0939fc00d9fe19d48d7a8e972'
        ) do |actual, expected|
          expect(actual.hash).to eq(expected.hash)
          expect(actual.contract).to eq(expected.contract)
        end
    ...
    context 'straightforward' do
      ...
      context 'perform' do
        it 'performs' do
          ...
          Contract.expect(
            action.to_h, 'ac91973911ee5018ed03a5a0d90dd15dd508ca33e4612aac7914843d898473c8'
          ) do |actual, expected|
            expect(actual.hash).to eq(expected.hash)
            expect(actual.contract).to eq(expected.contract)
          end
    ...
    context 'straightforward' do
      ...
      context 'perform' do
        it 'performs' do
          ...
          Contract.expect(
            action.to_h, '7a9a77d3b26b7f24ad095387b868767b1fb731b44f897c4db999be8510dbad43'
          ) do |actual, expected|
            expect(actual.hash).to eq(expected.hash)
            expect(actual.contract).to eq(expected.contract)
          end
      ...
      context 'straightforward' do
        ...
        context 'perform' do
          it 'performs' do
            ...
            Contract.expect(
              e.to_h, 'dcae6cfd1d85026057db959d2b9baf62d265bb463271f2aafbd7bed07358f960'
            ) do |actual, expected|
              expect(actual.hash).to eq(expected.hash)
              expect(actual.contract).to eq(expected.contract)
            end
