  ...
  describe 'pay invoice' do
    ...
    context 'straightforward' do
      ...
      context 'perform' do
        it 'performs' do
          ...
          Contract.expect(
            action.to_h, 'd365a12360212e06177995240dba5ed2130b9e99285fae6c49fc440a6ce96638'
          ) do |actual, expected|
            expect(actual.hash).to eq(expected.hash)
            expect(actual.contract).to eq(expected.contract)
          end
    ...
    context 'amp defined' do
      ...
      it 'performs' do
        ...
        Contract.expect(
          action.to_h, 'd20a704a606c6d4d3efd655176d9556522662523fc6713c0579f7b779ead6ca0'
        ) do |actual, expected|
          expect(actual.hash).to eq(expected.hash)
          expect(actual.contract).to eq(expected.contract)
        end
