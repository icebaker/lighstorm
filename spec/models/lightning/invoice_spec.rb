  ...
  describe 'kinds of invoice' do
    ...
    context 'spontaneous amp self-payment' do
      it 'models' do
        ...
        Contract.expect(
          invoice.to_h, 'a951aa59876623306c86383647ccf3b09a6fd5622d9699ed0bbae6b6ac7ac8e4'
        ) do |actual, expected|
          expect(actual.hash).to eq(expected.hash)
          expect(actual.contract).to eq(expected.contract)
        end
    ...
    context 'undefined amount payable indefinitely invoice' do
      it 'models' do
        ...
        Contract.expect(
          invoice.to_h, '3cab0ab4dd5f2223b76d5f2db207e07026ad2147c094222a623806f2006fc7bb'
        ) do |actual, expected|
          expect(actual.hash).to eq(expected.hash)
          expect(actual.contract).to eq(expected.contract)
        end
