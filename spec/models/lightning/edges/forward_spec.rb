...
require_relative '../../../../controllers/lightning/forward/all'

require_relative '../../../../models/lightning/edges/forward'

require_relative '../../../../ports/dsl/lighstorm/errors'

RSpec.describe Lighstorm::Model::Lightning::Forward do
  describe 'all' do
    context 'known peer' do
      it 'models' do
        data = Lighstorm::Controller::Lightning::Forward::All.data(
          Lighstorm::Controller::Lightning::Forward.components
        ) do |fetch|
          VCR.tape.replay('Controller::Lightning::Forward.all.last/known-peer') do
            data = fetch.call
        ...
        forward = described_class.new(data[0], Lighstorm::Controller::Lightning::Forward.components)
        ...
        expect(forward.in.channel.accounting.sent.millisatoshis).to eq(49_567_424_000)
        expect(forward.in.channel.accounting.sent.satoshis).to eq(49_567_424.0)
    ...
    context 'lost peer' do
      it 'models' do
        data = Lighstorm::Controller::Lightning::Forward::All.data(
          ...
          VCR.tape.replay('Controller::Lightning::Forward.all.last/lost-peer') do
            data = fetch.call
