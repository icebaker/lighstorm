...
require_relative '../../../adapters/bitcoin_address'
require_relative '../../../models/bitcoin_address'
    ...
    module BitcoinAddress
      module Create
        ...
        def self.adapt(response)
          Lighstorm::Adapter::BitcoinAddress.new_address(response)
        end

        def self.model(data, components)
          Models::BitcoinAddress.new(data, components)
        end
