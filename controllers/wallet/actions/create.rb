...
require_relative '../../../adapters/wallet/bitcoin'
require_relative '../../../models/wallet/address'
    ...
    module Wallet
      module Create
        ...
        def self.adapt(response)
          Lighstorm::Adapter::Bitcoin.new_address(response)
        end

        def self.model(data)
          Models::Wallet::Address.new(data)
        end
